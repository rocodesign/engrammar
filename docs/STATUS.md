...
- **Repo control boundaries** — you can disable Engrammar globally, disable it per repo, or isolate a repo into its own engram namespace without changing the rest of the system.
